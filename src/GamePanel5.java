...
public class GamePanel5 extends GameLevel {

    public static GameObstacle block[] = new GameObstacle[36];
    ...
    public static GameObstacle spikes[] = new GameObstacle[4];

    ImageIcon LBG = new ImageIcon(getClass().getResource("/BackgroundLevel5.png"));
    ...
    public GamePanel5() {
        ...
        block[1] = new GameObstacle(80 * 0, 80 * 4, BN.getImage());
        block[2] = new GameObstacle(80 * 0, 80 * 3, B.getImage());
        block[3] = new GameObstacle(80 * 0, 80 * 2, B.getImage());
        block[4] = new GameObstacle(80 * 0, 80 * 1, SB.getImage());
        block[5] = new GameObstacle(80 * 1, 80 * 7, SB.getImage());
        block[6] = new GameObstacle(80 * 3, 80 * 7, B.getImage());
        block[7] = new GameObstacle(80 * 3, 80 * 4, SBN.getImage());
        block[8] = new GameObstacle(80 * 4, 80 * 7, B.getImage());
        block[9] = new GameObstacle(80 * 4, 80 * 6, SB.getImage());
        block[10] = new GameObstacle(80 * 5, 80 * 7, B.getImage());
        block[11] = new GameObstacle(80 * 5, 80 * 6, B.getImage());
        block[12] = new GameObstacle(80 * 5, 80 * 5, SB.getImage());
        block[13] = new GameObstacle(80 * 6, 80 * 7, B.getImage());
        block[14] = new GameObstacle(80 * 6, 80 * 4, SBN.getImage());
        block[15] = new GameObstacle(80 * 7, 80 * 3, SBN.getImage());
        block[16] = new GameObstacle(80 * 9, 80 * 3, SBN.getImage());
        block[17] = new GameObstacle(80 * 10, 80 * 4, BN.getImage());
        block[18] = new GameObstacle(80 * 11, 80 * 3, BN.getImage());
        block[19] = new GameObstacle(80 * 11, 80 * 2, SB.getImage());
        block[20] = new GameObstacle(80 * 12, 80 * 3, BN.getImage());
        block[21] = new GameObstacle(80 * 13, 80 * 3, B.getImage());
        block[22] = new GameObstacle(80 * 13, 80 * 4, BN.getImage());
        block[23] = new GameObstacle(80 * 14, 80 * 3, BN.getImage());
        block[24] = new GameObstacle(80 * 14, 80 * 2, SB.getImage());
        block[25] = new GameObstacle(80 * 15, 80 * 4, BN.getImage());
        block[26] = new GameObstacle(80 * 15, 80 * 3, B.getImage());
        block[27] = new GameObstacle(80 * 15, 80 * 2, B.getImage());
        block[28] = new GameObstacle(80 * 15, 80 * 1, SB.getImage());
        block[29] = new GameObstacle(80 * 8, 80 * 7, SB.getImage());
        block[30] = new GameObstacle(80 * 10, 80 * 7, B.getImage());
        block[31] = new GameObstacle(80 * 11, 80 * 7, B.getImage());
        block[32] = new GameObstacle(80 * 13, 80 * 7, B.getImage());
        block[33] = new GameObstacle(80 * 14, 80 * 7, B.getImage());
        block[34] = new GameObstacle(80 * 15, 80 * 7, B.getImage());
        block[35] = new GameObstacle(-6, 640, 1292, 86, G.getImage());

        door = new GameObstacle(80 * 15, 80 * 5, 80, 160, IICD.getImage());

        key = new GameObstacle(80 * 14, 80 * 1, SK.getImage());

        token[0] = new GameObstacle(80 * 3, 80 * 6, TO.getImage());
        token[1] = new GameObstacle(80 * 4, 80 * 5, ST.getImage());
        token[2] = new GameObstacle(80 * 3, 80 * 3, ST.getImage());
        token[3] = new GameObstacle(80 * 9, 80 * 2, ST.getImage());
        token[4] = new GameObstacle(80 * 11, 80 * 1, ST.getImage());
        token[5] = new GameObstacle(80 * 8, 80 * 3, ST.getImage());
        token[6] = new GameObstacle(80 * 10, 80 * 6, TO.getImage());
        token[7] = new GameObstacle(80 * 13, 80 * 6, TO.getImage());
        token[8] = new GameObstacle(80 * 6, 80 * 6, TO.getImage());

        diamond = new GameObstacle(80 * 14, 80 * 4, D.getImage());

        acid[0] = new GameObstacle(80 * 10, 80 * 3, A.getImage());
        acid[1] = new GameObstacle(80 * 12, 80 * 2, A.getImage());
        acid[2] = new GameObstacle(80 * 13, 80 * 2, A.getImage());

        spikes[0] = new GameObstacle(80 * 2, 80 * 7, S.getImage());
        spikes[1] = new GameObstacle(80 * 7, 80 * 7, S.getImage());
        spikes[2] = new GameObstacle(80 * 9, 80 * 7, S.getImage());
        spikes[3] = new GameObstacle(80 * 12, 80 * 7, S.getImage());
    }
            ...
            if (GameFrame.snowMan.getBounds().intersects(acid[i].getVerticalCenter())) {
                ...
                if (GameFrame.snowMan.lives != 0) {
                    ...
                    try {
                        ...
                        Logger.getLogger(GamePanel5.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    T.start();
                }
            }
