...
public class GamePanel2 extends GameLevel {

    public static GameObstacle block[] = new GameObstacle[22];
    ...
    public static GameObstacle acid[] = new GameObstacle[9];

    ImageIcon LBG = new ImageIcon(getClass().getResource("/BackgroundLevel2.png"));
    ...
    public GamePanel2() {
        ...
        block[1] = new GameObstacle(320, 560, SB.getImage());
        block[2] = new GameObstacle(560, 560, B.getImage());
        block[3] = new GameObstacle(560, 480, B.getImage());
        block[4] = new GameObstacle(880, 560, SB.getImage());
        block[5] = new GameObstacle(1040, 560, B.getImage());
        block[6] = new GameObstacle(1040, 480, B.getImage());
        block[7] = new GameObstacle(1120, 560, B.getImage());
        block[8] = new GameObstacle(1120, 480, B.getImage());
        block[9] = new GameObstacle(1120, 400, SB.getImage());
        block[10] = new GameObstacle(1200, 560, B.getImage());
        block[11] = new GameObstacle(1200, 480, B.getImage());
        block[12] = new GameObstacle(1200, 400, B.getImage());
        block[13] = new GameObstacle(1200, 320, SB.getImage());
        block[14] = new GameObstacle(1040, 240, SBN.getImage());
        block[15] = new GameObstacle(800, 160, SBN.getImage());
        block[16] = new GameObstacle(560, 160, SBN.getImage());
        block[17] = new GameObstacle(480, 240, SBN.getImage());
        block[18] = new GameObstacle(160, 240, SBN.getImage());
        block[19] = new GameObstacle(80, 240, SBN.getImage());
        block[20] = new GameObstacle(0, 240, SBN.getImage());
        block[21] = new GameObstacle(-6, 640, 1292, 86, G.getImage());

        door = new GameObstacle(0, 80, 80, 160, IICD.getImage());

        key = new GameObstacle(720, 240, SK.getImage());

        token[0] = new GameObstacle(160, 320, TO.getImage());
        token[1] = new GameObstacle(320, 320, ST.getImage());
        token[2] = new GameObstacle(560, 240, TO.getImage());
        token[3] = new GameObstacle(1200, 240, ST.getImage());
        token[4] = new GameObstacle(560, 80, ST.getImage());
        token[5] = new GameObstacle(320, 80, ST.getImage());

        diamond = new GameObstacle(640, 480, SD.getImage());
        ...
        acid[4] = new GameObstacle(480, 560, A.getImage());
        acid[5] = new GameObstacle(640, 560, A.getImage());
        acid[6] = new GameObstacle(720, 560, A.getImage());
        acid[7] = new GameObstacle(800, 560, A.getImage());
        acid[8] = new GameObstacle(960, 560, A.getImage());
    }
            ...
            if (GameFrame.snowMan.getBounds().intersects(acid[i].getVerticalCenter())) {
                ...
                if (GameFrame.snowMan.lives != 0) {
                    ...
                    try {
                        ...
                        Logger.getLogger(GamePanel2.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    T.start();
                }
            }
