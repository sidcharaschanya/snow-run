...
public class GamePanel4 extends GameLevel {

    public static GameObstacle block[] = new GameObstacle[47];
    public static GameObstacle door;
    public static GameObstacle key;
    public static GameObstacle token[] = new GameObstacle[8];
    public static GameObstacle diamond;
    public static GameObstacle acid[] = new GameObstacle[8];
    public static GameObstacle blackLife;
    public static GameObstacle spikes;

    ImageIcon LBG = new ImageIcon(getClass().getResource("/BackgroundLevel4.png"));
    ...
    public GamePanel4() {
        ...
        ImageIcon S = new ImageIcon(getClass().getResource("/Spikes.png"));

        block[0] = new GameObstacle(80 * 0, 80 * 7, B.getImage());
        block[1] = new GameObstacle(80 * 3, 80 * 7, B.getImage());
        block[2] = new GameObstacle(80 * 3, 80 * 6, B.getImage());
        block[3] = new GameObstacle(80 * 4, 80 * 7, B.getImage());
        block[4] = new GameObstacle(80 * 4, 80 * 6, B.getImage());
        block[5] = new GameObstacle(80 * 4, 80 * 5, SB.getImage());
        block[6] = new GameObstacle(80 * 5, 80 * 7, B.getImage());
        block[7] = new GameObstacle(80 * 5, 80 * 6, B.getImage());
        block[8] = new GameObstacle(80 * 5, 80 * 5, B.getImage());
        block[9] = new GameObstacle(80 * 5, 80 * 4, SB.getImage());
        block[10] = new GameObstacle(80 * 6, 80 * 7, B.getImage());
        block[11] = new GameObstacle(80 * 6, 80 * 6, B.getImage());
        block[12] = new GameObstacle(80 * 6, 80 * 5, B.getImage());
        block[13] = new GameObstacle(80 * 6, 80 * 4, B.getImage());
        block[14] = new GameObstacle(80 * 6, 80 * 3, B.getImage());
        block[15] = new GameObstacle(80 * 6, 80 * 2, SB.getImage());
        block[16] = new GameObstacle(80 * 3, 80 * 3, SBN.getImage());
        block[17] = new GameObstacle(80 * 0, 80 * 3, BN.getImage());
        block[18] = new GameObstacle(80 * 0, 80 * 2, SB.getImage());
        block[19] = new GameObstacle(80 * 7, 80 * 7, B.getImage());
        block[20] = new GameObstacle(80 * 7, 80 * 3, SBN.getImage());
        block[21] = new GameObstacle(80 * 8, 80 * 5, SBN.getImage());
        block[22] = new GameObstacle(80 * 9, 80 * 5, BN.getImage());
        block[23] = new GameObstacle(80 * 9, 80 * 4, B.getImage());
        block[24] = new GameObstacle(80 * 9, 80 * 3, B.getImage());
        block[25] = new GameObstacle(80 * 9, 80 * 2, SB.getImage());
        block[26] = new GameObstacle(80 * 10, 80 * 6, BN.getImage());
        block[27] = new GameObstacle(80 * 10, 80 * 5, B.getImage());
        block[28] = new GameObstacle(80 * 10, 80 * 4, B.getImage());
        block[29] = new GameObstacle(80 * 10, 80 * 3, B.getImage());
        block[30] = new GameObstacle(80 * 11, 80 * 6, BN.getImage());
        block[31] = new GameObstacle(80 * 11, 80 * 5, B.getImage());
        block[32] = new GameObstacle(80 * 11, 80 * 4, B.getImage());
        block[33] = new GameObstacle(80 * 11, 80 * 3, B.getImage());
        block[34] = new GameObstacle(80 * 12, 80 * 4, BN.getImage());
        block[35] = new GameObstacle(80 * 12, 80 * 3, B.getImage());
        block[36] = new GameObstacle(80 * 12, 80 * 2, SB.getImage());
        block[37] = new GameObstacle(80 * 13, 80 * 4, BN.getImage());
        block[38] = new GameObstacle(80 * 13, 80 * 3, B.getImage());
        block[39] = new GameObstacle(80 * 14, 80 * 4, BN.getImage());
        block[40] = new GameObstacle(80 * 14, 80 * 3, B.getImage());
        block[41] = new GameObstacle(80 * 15, 80 * 4, BN.getImage());
        block[42] = new GameObstacle(80 * 15, 80 * 3, B.getImage());
        block[43] = new GameObstacle(80 * 15, 80 * 2, SB.getImage());
        block[44] = new GameObstacle(80 * 14, 80 * 7, B.getImage());
        block[45] = new GameObstacle(80 * 15, 80 * 7, B.getImage());
        block[46] = new GameObstacle(-6, 640, 1292, 86, G.getImage());

        door = new GameObstacle(80 * 15, 80 * 5, 80, 160, IICD.getImage());

        key = new GameObstacle(80 * 12, 80 * 1, SK.getImage());

        token[0] = new GameObstacle(80 * 0, 80 * 4, TO.getImage());
        token[1] = new GameObstacle(80 * 0, 80 * 1, ST.getImage());
        token[2] = new GameObstacle(80 * 6, 80 * 1, ST.getImage());
        token[3] = new GameObstacle(80 * 7, 80 * 6, TO.getImage());
        token[4] = new GameObstacle(80 * 7, 80 * 2, ST.getImage());
        token[5] = new GameObstacle(80 * 8, 80 * 4, ST.getImage());
        token[6] = new GameObstacle(80 * 9, 80 * 1, ST.getImage());
        token[7] = new GameObstacle(80 * 10, 80 * 7, TO.getImage());

        diamond = new GameObstacle(80 * 15, 80 * 1, SD.getImage());

        acid[0] = new GameObstacle(80 * 1, 80 * 7, A.getImage());
        acid[1] = new GameObstacle(80 * 2, 80 * 7, A.getImage());
        acid[2] = new GameObstacle(80 * 1, 80 * 3, AN.getImage());
        acid[3] = new GameObstacle(80 * 2, 80 * 3, AN.getImage());
        acid[4] = new GameObstacle(80 * 10, 80 * 2, A.getImage());
        acid[5] = new GameObstacle(80 * 11, 80 * 2, A.getImage());
        acid[6] = new GameObstacle(80 * 13, 80 * 2, A.getImage());
        acid[7] = new GameObstacle(80 * 14, 80 * 2, A.getImage());

        blackLife = new GameObstacle((80 * 9) + 10, (80 * 6) + 10, 60, 60, BL.getImage());

        spikes = new GameObstacle(80 * 13, 80 * 7, S.getImage());
    }
    ...
    public void paintComponent(Graphics G) {
        ...
        g2d.drawImage(spikes.getImg(), spikes.getX(), spikes.getY(), this);
    ...
    public static boolean hasVerticalCollision() {
        ...
        if (GameFrame.snowMan.getBounds().intersects(spikes.getBottom()) && GameFrame.snowMan.dy < 0) {
            GameFrame.snowMan.dy = 0;
            return true;
        }
        return false;
    ...
    public static boolean hasHorizontalCollision() {
        ...
        if (GameFrame.snowMan.getBounds().intersects(spikes.getSmallerRight()) && GameFrame.snowMan.dx < 0) {
            return true;
        }
        if (GameFrame.snowMan.getBounds().intersects(spikes.getSmallerLeft()) && GameFrame.snowMan.dx > 0) {
            return true;
        }
        return false;
    }
    ...
    public void hasCollision() {
            ...
            if (GameFrame.snowMan.getBounds().intersects(acid[i].getVerticalCenter())) {
                ...
                if (GameFrame.snowMan.lives != 0) {
                    ...
                    try {
                        ...
                        Logger.getLogger(GamePanel4.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    T.start();
                }
            }
        ...
        if (GameFrame.snowMan.getBounds().intersects(spikes.getVerticalQuarter())) {
            GameFrame.snowMan.x = 15;
            GameFrame.snowMan.y = 480;
            GameFrame.snowMan.lives--;
            if (GameFrame.snowMan.lives != 0) {
